...
<html lang="en">
  <head>
    ...
    <!-- <script type="text/javascript" src=https://maps.googleapis.com/maps/api/js?key=AIzaSyANIx4N48kL_YEfp-fVeWmJ_3MSItIP8eI&callback=basemap>></script> -->
      <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgpfxdQ0Ep_nieNjV64u4yXWeSFHAT4BE&callback=initMap"></script>
        ...
        { 
         ...
         for (var i in rows) 
          { 
            ...
            infowindow = new google.maps.InfoWindow({
            position: centerBaru,
              content: "<center><span style=color:black><b>Information</b><table><tr><td><i class='fa fa-home'></i>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td><i class='fa fa-map-marker'></i>address</td><td>:</td><td> "+address+"</td></tr><br><tr><td><i class='fa fa-phone'></i>Telepon</td><td>:</td><td> "+cp+"</td></tr><br><tr><td><i class='fa fa-clock-o'></i>Owner</td><td>:</td><td> "+owner+"</td></tr></table></span><br><a style=color:white class='btn btn-success fa fa-road' title = 'route'role=botton onclick='callRoute(centerLokasi,centerBaru);rutetampil()' /></a>&nbsp&nbsp<a style=color:white class='btn btn-success fa fa-info' title='info' role=botton onclick='gallery(\""+id+"\")'<br></a>&nbsp&nbsp <a style=color:white class='btn btn-success fa fa-compass' title='nearby' role=botton' onclick='tampil_sekitar(\""+latitude+"\",\""+longitude+"\",\""+name+"\")'<br></a><br>",  
            pixelOffset: new google.maps.Size(0, -33)
            });
        ...
        { 
         ...
         for (var i in rows) 
          { 
            ...
            infowindow = new google.maps.InfoWindow({
            position: centerBaru,
           content: "<center><span style=color:black><b>Information</b><table><tr><td><i class='fa fa-home'></i>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td><i class='fa fa-map-marker'></i>address</td><td>:</td><td> "+address+"</td></tr><br><tr><td><i class='fa fa-phone'></i>Telepon</td><td>:</td><td> "+cp+"</td></tr><br><tr><td><i class='fa fa-clock-o'></i>Owner</td><td>:</td><td> "+owner+"</td></tr></table></span><br><a style=color:white class='btn btn-success fa fa-compass' title='object Arround' role=botton' onclick='tampil_sekitar(\""+latitude+"\",\""+longitude+"\",\""+name+"\")'<br></a>&nbsp&nbsp<a style=color:white class='btn btn-success fa fa-info' title='info' role=botton onclick='gallery(\""+id+"\")'<br></a>&nbsp&nbsp <a style=color:white class='btn btn-success fa fa-road' title = 'route'role=botton onclick='callRoute(centerLokasi,centerBaru);rutetampil()' /></a><br>",  
            pixelOffset: new google.maps.Size(0, -33)
            });
          infoposisi.push(infowindow); 
          hapusInfo();
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          console.log(name);
          // if(tabel == 'sou'){
           $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title ='info'onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title = 'angkot' onclick='souangkot(\""+id+"\",\""+lat+"\",\""+lon+"\");ikangkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
            
          // } else {
          //  $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detsouxx(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          $('#hasilcari').append("<tr><td>"+nama+"</td><td><a role='button' class='btn btn-success fa fa-info' title = 'info'onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title = 'angkot' onclick='souangkot(\""+id+"\",\""+lat+"\",\""+lon+"\");ikangkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          $('#hasilcari').append("<tr><td>"+nama+"</td><td><a role='button' class='btn btn-success fa fa-info' title = 'info'onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title = 'angkot' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          console.log(id_status);
          // if (tabel == 'sou') {
            $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='souangkot(\""+id+"\",\""+lat+"\",\""+lon+"\");ikangkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");          // } else {
          //   $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detsouxx(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
          // }
          // $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");detsouxx(\""+id+"\");'>Show</a></td><td><a role='button' class='btn btn-danger fa fa-taxi' onclick='souangkot(\""+id+"\")'></a></td></tr>");
        }   
        ...
        { 
         for (var i in rows) 
          { 
            ...
            infowindow = new google.maps.InfoWindow({
            position: centerBaru,
            content: "<center><span style=color:black><b>Information</b><br><table><tr><td><i class='fa fa-home'></i>Nama Hotel</td><td>:</td><td> "+name+"</td></tr><br><tr><td><i class='fa fa-map-marker'></i>address</td><td>:</td><td> "+address+"</td></tr><br><tr><td><i class='fa fa-phone'></i>Telepon</td><td>:</td><td> "+cp+"</td></tr></table></span>",   
            pixelOffset: new google.maps.Size(0, -33)
            });
          infoposisi.push(infowindow); 
          hapusInfo();
            ...
            for (var i in rows) 
              { 
               ...
               var description = row.description;
                ...
                infowindow.open(map,marker);
                console.log(id_angkot);
                $('#tampillistangkotik').append("<tr><td>"+id_angkot+"</td><td><a role='button' class='btn btn-success fa fa-road' onclick='detailangkot(\""+id_angkot+"\",\""+lat+"\",\""+lng+"\",\""+lat1+"\",\""+lng1+"\")'></a></td></tr>");
              }
            }
           }
         });  
        ...
        if(rows==null)
          ...
          for (var i in rows) 
              ...
              ({
                ...
                map.setZoom(16);
                clickMarker(centerBaru, id);
                $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='angkot' onclick='souangkot(\""+id+"\",\""+lat+"\",\""+lon+"\");ikangkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
              }
      ...
      if(rows==null && arrayLay2.length != 0)
        ...
        for (var i in rows) 
            ...
            ({
              ...
              map.setZoom(16);
              clickMarker(centerBaru, id);
              $('#hasilcari').append("<tr><td>"+nama_tempat_kuliner+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
            }
            // jml = jml + rows.length;
            // alert('hai')
    ...
    { 
      ...
      else
      {
        ...
        { 
          ...
          map.setZoom(13);
           clickMarker(centerBaru, id); 
           $('#hasilcari').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detik(\""+id+"\");detikik(\""+id+"\");'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='ikangkot(\""+id+"\")'></a></td></tr>");
        }
      } 
      // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
    }
...
function kuliner_sekitar(latitude,longitude,rad){ //KULINER SEKITAR 
          ...
          $.ajax({url: server+'_sekitar_kuliner.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#hasilcariculi').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detculi(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-road' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='kulAngkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
...
function tw_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR 
          ...
          $.ajax({url: server+'_sekitar_tw.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#hasilcariobj').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-info' onclick='detailinfoobj(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-road' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' onclick='owangkot(\""+id+"\",\""+lat+"\",\""+lon+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
    ...
    ({ 
      ...
      { 
        ...
        {   
          ...
          clickMarker(centerBaru, id);
          console.log(id);
         $('#hasilcari').append("<tr><td>"+name+"</td><td style='text-align:center;' ><a role='button' class='btn btn-success fa fa-info' title='info' onclick='detsou(\""+id+"\");detsousou(\""+id+"\");'></a></td ><td style='text-align:center;' ><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' onclick='souangkot(\""+id+"\",\""+latitude+"\",\""+longitude+"\")'></a></td></tr>");
        }   
        // $('#hasilpencarian').append("<h5 class='box-title' id='hasilpencarian'>Result :</h5>"+rows.length);
      }
    }); 
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="background-color:black;border-bottom: 1px solid black;">
            ...
            <!--logo start-->
            <a href="index.php" class="logo" style="font-family: Lucida Console;text-transform: capitalize;"><b>WebGIS Souvenir <i class="fa fa-" aria-hidden="true"></i> (06 - 1811521010 - Aditya Ilham Ramadhan)</b></a>
    ...
    /* akhir style slider popular  */
            ...
            <section class="panel">
               <header class="panel-heading">
                <label style="color: black">Google Map With Location List :</label>
                   <button type="button" onclick="posisisekarang()" class="btn btn-success " data-toggle="tooltip" id="posisinow" title="Posisi Saya" 
                    ><i class="fa fa-location-arrow" > </i>
                       ...
                       <label id="tombol">
                       <a type="button" onclick="legenda()" id="showlegenda" class="btn btn-success" data-toggle="tooltip" title="Legenda" style="margin-right: 7px;"><i class="fa fa-eye" style="color:white;"></i>
                       </a>
                       </label>
                  </header>
                <!-- First Action -->
                      ...
                      <!--custom chart end-->
                        ...
                        <div class="col-lg-4 ds"  id="tampilangkotsekitarik" style="display:none;" >
                          ...
                          <!-- <h3 style="font-size:16px">Angkot Information</h3> -->
                              <a class="btn btn-compose" style="background-color:black;color: white">Local Transport</a>
                              <div class="box-body" style="max-height:450px;overflow:auto;">
      ...
      *********************************************************************************************************************************************************** -->    
      ...
      <!-- batas awal popular tourism clickable -->
                ...
                <div id="view_kanan_table" class="col-md-4 col-sm-4 mb">    
                   <div class="white-panel pns" style="height: 530px;">
                        ...
                        <div style="height:500px; margin-left:40px;margin-right:40px;">
                          ...
                          <div class="container2" style="padding-top:0px;">
                            ...
                            <div class="mySlides">
                                ...
                                <a href="javascript:;" onclick='viewtipea();'  id="caritipesou" value="a"><img style="width:100%" src='../_foto/sanjay.jpg' astyle="width:100%" value="a"></a>
                                <!-- <h5 style="color:black">Sanjai</h5> -->
                              </div>

                              <div class="mySlides">
                                  
                                <a href="javascript:;" onclick='viewtipeb();' id="caritipesou" value="b" ><img src="../_foto/coff.jpg" style="width:100%" value="a"></a>
                                <!-- <h5 style="color:black">Samek</h5> -->
                              </div>

                              <div class="mySlides">
                              
                               <a href="javascript:;" onclick='viewtiped();' id="caritipesou" value="d" ><img src="../_foto/bktshirt.jpg" style="width:100%" value="d"></a>
                                <!-- <h5 style="color:black">Tangkelek</h5> -->
                              </div>
                                
                              <div class="mySlides">
                              
                              <a href="javascript:;" onclick='viewtipec();' id="caritipesou" value="c" ><img src="../_foto/cake.jpg" style="width:100%" value="c"></a>
                            ...
                            <div class="row2">
                              <div class="column">
                                <img class="demo cursor" src="../_foto/sanjay.jpg" style="width:100%;" onclick="currentSlide(1)">
                              </div>
                              <div class="column">
                                <img class="demo cursor" src="../_foto/coff.jpg" style="width:100%;" onclick="currentSlide(2)">
                              </div>
                              <div class="column">
...
<!-- batas akhir popular tourism clickable -->  
        ...
        <div class="col-sm-4"  id="hasilik">
          ...
          <a class="btn btn-compose" style="background-color:black;">Result</a>
              ...
              <div class="box-body" style="max-height:370px;overflow:auto;">
      ...
      <div id="nearbyik" class="col-md-4 col-sm-4 mb" style="display:none">
                        <div class="white-panel pns" style="padding-bottom:5px">
                           <div class="white-header" style="height:40px;margin-bottom:25px;background:white;color:black">
        ...
        <div class="col-lg-4 ds"  id="hasilrute" style="display:none;">
          ...
          <a class="btn btn-compose" style="background-color:black;color:white;">Rute</a>
              <!-- First Action -->
        ...
        <div class="col-lg-4 ds"  id="selectkulll" style="display:none;">
          ...
          <a class="btn btn-compose" style="background-color: black;color: white">Select Souvenir</a>
