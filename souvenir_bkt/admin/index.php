...
<html lang="en">
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgpfxdQ0Ep_nieNjV64u4yXWeSFHAT4BE&callback=drawing"></script>
  ...
  <section id="container" >
    ...
    <div id="sidebar"  class="nav-collapse " >
        ...
        <section id="main-content">
          ...
          <h4 class="btn btn-compose" style="background-color:black;border-bottom: 1px solid black;">MANAGE THE DATA</h4>
               </div>
