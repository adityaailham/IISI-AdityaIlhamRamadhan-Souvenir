				...
				<input type="text" class="form-control hidden" id="id" name="id" value="<?php echo $id_souvenir ?>">
					...
					<tr>
						...
						<?php
							...
							{ ?> <tr> <?php
								$sql3 = pg_query($conn,"SELECT * FROM detail_product_souvenir where id_souvenir='$id_souvenir' and id_product=$dt[id]");
								...
								if ($dt['id']==$data3['id_product']){
									...
									echo"<td><input class='form-control ' type='number' style='margin-bottom:10px;width:200px' id='harga".$dt['id']."'  name='harga".$dt['id']."' value='0' disabled></td>";
								}
