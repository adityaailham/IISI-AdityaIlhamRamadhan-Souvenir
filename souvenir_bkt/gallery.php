                  ...
                  <div class="panel-body">
                    <form method="POST" action="insert_comment.php">
                        <table id="detgal" class="table">
                          <tbody  style='vertical-align:top;'>
                          <input type="hidden" name="id" value="<?php echo $_GET['idgallery']; ?>">
                          <tr><td>name :</td><td><textarea name="nama" cols="30" rows='1'></textarea></td></tr>
             ...
             for (var i in rows) 
              { 
                ...
                map.setZoom(18); 
                    ...
                    if(i==0){
                      $('#detgal').append("<tr><td>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td>Address</td><td>:</td><td> "+address+"</td></tr><br><tr><td>Telephone</td><td>:</td><td> "+cp+"</td></tr><br><tr><td>Owner</td><td>:</td><td> "+owner+"</td></tr><br><tr><td>Place's Status</td><td>:</td><td> "+status+"</td></tr><td></td></tr><tr><td><b> Product </b></td><td></td><td><b> Price </b></td></tr>");
                    }
